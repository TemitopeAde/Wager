                                ...
                                >
                                    <Grid xs={6} item>
                                        ...
                                        >
                                            ...
                                            <Box sx={{ width: '200px'}} component="div">
                ...
                >
                    ...
                    >   
                        ...
                        <Box sx={{
                            ...
                            <Typography onClick={() => navigate("/terms-and-condition")} sx={{marginBottom: '10px',fontFamily: 'Poppins',fontSize: '1.2rem'}} variant="h6"><Link sx={{ color: '#fff', cursor: 'pointer'}}>TERMS AND CONDITION</Link></Typography>
                    ...
                    >
                        ...
                        <Box>
                            <Typography onClick={() => navigate("/login")} sx={{marginBottom: '10px',fontFamily: 'Poppins',fontSize: '1.2rem', cursor: 'pointer'}} variant="h6"><Link sx={{color: '#fff'}} >LOGIN</Link></Typography>
                            <Typography onClick={() => navigate("/login")} sx={{marginBottom: '10px',fontFamily: 'Poppins',fontSize: '1.2rem', cursor: 'pointer'}} variant="h6"><Link sx={{color: '#fff'}} >REGISTER</Link></Typography>
                        </Box>
                    ...
                    >   
                        ...
                        <form  onSubmit={formik.handleSubmit}>
                            ...
                            >
                                <FormGroup>
                                    <FormControlLabel control={<Checkbox color='secondary' sx={{background: "#fff"}} />} label={label} />
